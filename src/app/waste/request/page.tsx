...
import { WasteRequestDTO } from "@/types/waste";
...
const INITIAL_FORM: WasteRequestDTO = {
  laboratoryId: "",
  wasteType: "",
  emissionAmount: "",
...
export default function WasteRequestPage() {
  const [form, setForm] = useState<WasteRequestDTO>(INITIAL_FORM);
